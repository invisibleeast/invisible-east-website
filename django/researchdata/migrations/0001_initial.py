# Generated by Django 4.2.1 on 2023-07-01 13:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('administrative_internal_correspondences', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='researchdata.sltextsubjectadministrativeinternalcorrespondence')),
                ('administrative_lists_and_accounting', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='researchdata.sltextsubjectadministrativelistsandaccounting')),
                ('administrative_tax_receipts', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='researchdata.sltextsubjectadministrativetaxreceipts')),
                ('agricultural_produce', models.ManyToManyField(blank=True, db_index=True, help_text='Agricultural produce, animals, and farming equipment', related_name='texts', to='researchdata.sltextsubjectagriculturalproduce')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='texts', to='researchdata.sltextcategory')),
                ('collection', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='texts', to='researchdata.sltextcollection')),
                ...
                ('currencies_and_denominations', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='researchdata.sltextsubjectcurrenciesanddenominations')),
                ...
                ('documentations', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='researchdata.sltextsubjectdocumentation')),
                ('finance_and_accountancy_phrases', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='researchdata.sltextsubjectfinanceandaccountancyphrases')),
                ('funders', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='researchdata.slfunder')),
                ('geographic_administrative_units', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='researchdata.sltextsubjectgeographicadministrativeunits')),
                ('land_measurement_units', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='researchdata.sltextsubjectlandmeasurementunits')),
                ('languages', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='researchdata.sltextlanguage')),
                ('legal_and_administrative_stock_phrases', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='researchdata.sltextsubjectlegalandadministrativestockphrases')),
                ('legal_transactions', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='researchdata.sltextsubjectlegaltransactions')),
                ('markings', models.ManyToManyField(blank=True, db_index=True, help_text='Scribal markings, ciphers, abbreviations, para-text, column format', related_name='texts', to='researchdata.sltextsubjectmarkings')),
                ...
                ('people_and_processes_admins', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='researchdata.sltextsubjectpeopleandprocessesadmin', verbose_name='People and processes involved in public administration, tax, trade, and commerce')),
                ('people_and_processes_legal', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='researchdata.sltextsubjectpeopleandprocesseslegal', verbose_name='People and processes involved in legal and judiciary system')),
                ...
                ('religions', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='researchdata.sltextsubjectreligion')),
                ('texts', models.ManyToManyField(blank=True, through='researchdata.M2MTextToText', to='researchdata.text')),
                ('toponyms', models.ManyToManyField(blank=True, db_index=True, help_text='Place names', related_name='texts', to='researchdata.sltextsubjecttoponym')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='texts', to='researchdata.sltexttype')),
