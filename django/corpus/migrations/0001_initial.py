    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_unidecode', models.CharField(blank=True, max_length=1000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, max_length=1000)),
                ('name_unidecode', models.CharField(blank=True, db_index=True, max_length=1000, null=True)),
                ('alternative_readings', models.CharField(blank=True, max_length=1000, null=True)),
                ('other_attested_forms', models.CharField(blank=True, max_length=1000, null=True)),
                ('latitude', models.CharField(blank=True, help_text='Optional. Use if you want this toponym to appear on maps in the public interface.', max_length=255, null=True)),
                ('longitude', models.CharField(blank=True, help_text='Optional. Use if you want this toponym to appear on maps in the public interface.', max_length=255, null=True)),
                ('urls', models.TextField(blank=True, help_text='Optional. Add URLs that relate to this toponym (add one URL per line). Must be a full URL e.g. "https://www.google.com"', null=True)),
                ('notes', models.TextField(blank=True, help_text='Optional. Notes included here are only visible in admin dashboard, not on public interface.', null=True)),
            ],
            options={
                'ordering': [django.db.models.functions.text.Upper('name_unidecode'), 'id'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gregorian_date_text', models.CharField(blank=True, help_text='Format date as free text - e.g. "11 February 1198" or "January-February 1162".<br>For help converting original dates to the Gregorian calendar please see <a href="https://www.muqawwim.com" target="_blank">www.muqawwim.com</a>', max_length=1000, null=True)),
                ...
                ('commentary', ckeditor.fields.RichTextField(blank=True, help_text='<br>Commentary will not be displayed on the public website. It is for internal project team purposes only.', null=True)),
                ...
                ('toponyms', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='corpus.sltexttoponym')),
        ...
        migrations.AddField(
            model_name='m2mtexttotext',
            name='text_2',
            field=models.ForeignKey(help_text='For use when separate shelfmarks are used for the recto and verso of the same document, or to link multiple dispersed folios from a single codex.', on_delete=django.db.models.deletion.CASCADE, related_name='text_2', to='corpus.text', verbose_name='text'),
        ),
        migrations.AddField(
