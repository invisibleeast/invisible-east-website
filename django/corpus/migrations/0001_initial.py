    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('century', models.ForeignKey(blank=True, help_text='Uses the Gregorian calendar. This field is used to filter and sort results in the public interface. More specific data about dates can be added below in the "Text Dates" section of this form.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='corpus.sltextcentury')),
