# Generated by Django 4.2.4 on 2023-09-29 10:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('urls', models.TextField(blank=True, help_text='Optional. Add URLs that relate to this tag (add one URL per line).', null=True)),
            ],
            options={
                'ordering': [django.db.models.functions.text.Upper('category__name'), django.db.models.functions.text.Upper('name'), 'id'],
            },
