# Generated by Django 4.2.4 on 2023-09-23 13:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, max_length=1000)),
                ('latitude', models.CharField(blank=True, help_text='Use if this tag can be located on a map (e.g. is a toponym)', max_length=255, null=True)),
                ('longitude', models.CharField(blank=True, help_text='Use if this tag can be located on a map (e.g. is a toponym)', max_length=255, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='SlTextWritingSupportDetails',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, max_length=1000)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary_of_content', ckeditor.fields.RichTextField(blank=True, help_text='Always paste content without formatting (Windows: Ctrl + Shift + P, Mac: Cmd + Shift + P)', null=True)),
                ('commentary', ckeditor.fields.RichTextField(blank=True, help_text='Always paste content without formatting (Windows: Ctrl + Shift + P, Mac: Cmd + Shift + P)<br>Commentary will not be displayed on the public website. It is for internal project team purposes only.', null=True)),
                ...
                ('writing_support_details', models.ManyToManyField(blank=True, db_index=True, related_name='texts', to='corpus.sltextwritingsupportdetails')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transcription', ckeditor.fields.RichTextField(blank=True, help_text='Always paste content without formatting (Windows: Ctrl + Shift + P, Mac: Cmd + Shift + P)<br>\nTo start creating lines of text click the \'numbered list\' button\n<br>\nTo manually override an automatic line number simply:\n<br>\n&nbsp;&nbsp;&nbsp;&nbsp;1. Click the \'Source\' button\n<br>\n&nbsp;&nbsp;&nbsp;&nbsp;2. Add a value to the <em>&lt;li&gt;</em>. E.g. change <em>&lt;li&gt;</em> to <em>&lt;li value="4"&gt;</em>\n<br>\n&nbsp;&nbsp;&nbsp;&nbsp;3. If last line is a range (e.g. 8-9) add <em>\'data-range-end\'</em>. E.g. <em>&lt;li data-range-end="9"&gt;</em>\n', null=True)),
                ('translation', ckeditor.fields.RichTextField(blank=True, help_text='Always paste content without formatting (Windows: Ctrl + Shift + P, Mac: Cmd + Shift + P)<br>\nTo start creating lines of text click the \'numbered list\' button\n<br>\nTo manually override an automatic line number simply:\n<br>\n&nbsp;&nbsp;&nbsp;&nbsp;1. Click the \'Source\' button\n<br>\n&nbsp;&nbsp;&nbsp;&nbsp;2. Add a value to the <em>&lt;li&gt;</em>. E.g. change <em>&lt;li&gt;</em> to <em>&lt;li value="4"&gt;</em>\n<br>\n&nbsp;&nbsp;&nbsp;&nbsp;3. If last line is a range (e.g. 8-9) add <em>\'data-range-end\'</em>. E.g. <em>&lt;li data-range-end="9"&gt;</em>\n', null=True)),
                ('transliteration', ckeditor.fields.RichTextField(blank=True, help_text='Always paste content without formatting (Windows: Ctrl + Shift + P, Mac: Cmd + Shift + P)<br>Optional. Only relevant to some Middle Persian texts.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.CharField(blank=True, help_text='Format: "YYYY-MM-DD" e.g. "0608-01-31" (ensure years before 1000 start with 0, e.g. 0608 not 608)', max_length=1000, null=True)),
                ('date_range_start', models.CharField(blank=True, help_text='Format: "YYYY-MM-DD" e.g. "0608-01-31" (ensure years before 1000 start with 0, e.g. 0608 not 608)', max_length=1000, null=True)),
                ('date_range_end', models.CharField(blank=True, help_text='Format: "YYYY-MM-DD" e.g. "0608-01-31" (ensure years before 1000 start with 0, e.g. 0608 not 608)', max_length=1000, null=True)),
