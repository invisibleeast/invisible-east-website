    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('public_review_ready', models.BooleanField(default=False, help_text='Tick this box to mark this Corpus Text as ready to be reviewed by the editor. If the editor approves it, this Corpus Text will then be visible on the public website. The editor will be notified via email when you tick this box.')),
                ('public_review_notes', models.TextField(blank=True, help_text='Optional. Include any necessary comments, feedback, or notes during the review process.', null=True)),
                ('public_review_approved', models.BooleanField(default=False, help_text='Tick to approve this Corpus Text. This will make it visible on the public website.')),
                ('public_review_approved_datetime', models.DateTimeField(blank=True, null=True)),
                ...
                ('admin_contributors', models.ManyToManyField(blank=True, help_text='Users who have contributed to this Corpus Text (e.g. co-editors, data entry persons, etc.) but are not the principal editor or data entry person', related_name='text_admin_contributors', to=settings.AUTH_USER_MODEL)),
                ('admin_principal_data_entry_person', models.ForeignKey(blank=True, help_text='The main person who has entered the data for this Corpus Text into the database', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='text_admin_principal_data_entry_person', to=settings.AUTH_USER_MODEL)),
                ('admin_principal_editor', models.ForeignKey(blank=True, help_text='The main person responsible for this Corpus Text', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='text_admin_principal_editor', to=settings.AUTH_USER_MODEL)),
                ...
                ('public_review_approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='text_public_review_approval', to=settings.AUTH_USER_MODEL)),
